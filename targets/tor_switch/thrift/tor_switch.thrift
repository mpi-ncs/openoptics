...
struct PortQueueMetric {
  1:required i32 port;
  2:required i32 queue;
...
struct MonitorResult {
  1:required list<PortQueueMetric> port_queue_metrics;
  2:required i32 drop_ctr;
}
...
service TorSwitch {
  ...
  i32 set_active_queue(1:i32 qid);
  i32 get_active_queue();
  ...
  MonitorResult get_device_metric();
