...
#include <bm/tor_switch_types.h> // For MonitorResult
...
class TorSwitch : public Switch {
 ...
 public:
  ...
  size_t set_active_queue(size_t active_q);
  ...
  void get_device_metric(tswitch_runtime::MonitorResult& _return) const;
